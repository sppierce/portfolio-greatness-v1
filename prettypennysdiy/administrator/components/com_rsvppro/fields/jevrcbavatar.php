...
<div class="rsvpclear"></div>
	...
	function getInput()
	{
		...
		if ($user->id==0){
			$avatarImgPath = $baseurl . '/components/com_comprofiler/plugin/templates/default/images/canvas/tnnophoto.jpg';
			...
			if ($user->cbProfile){
				...
				if ( !empty( $user->cbProfile->avatar ) )
				{
					...
					{
						$avatarImgPath = $baseurl . '/components/com_comprofiler/plugintemplates/default/images/canvas/tnpendphoto.jpg';
					}
				}
