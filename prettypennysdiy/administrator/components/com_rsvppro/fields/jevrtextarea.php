	...
	function getInput()
	{
		...
		if ($this->attribute("peruser")==1 || $this->attribute("peruser")==2){
			...
			foreach ($value as $val){
				...
				$html .= '<textarea name="'.$elementname.'" '.$placeholder.' cols="'.$cols.'" rows="'.$rows.'" '.$thisclass.' id="'.$id."_".$i.'" >'.$val.'</textarea>';
			...
			$html .= '<textarea name="paramtmpl_'.$elementname.'" '.$placeholder.' cols="'.$cols.'" rows="'.$rows.'" '.$thisclass.' id="'.$id.'_xxx" >'.$val.'</textarea>';
			...
			$html = '<textarea name="'.$elementname.'" '.$placeholder.' cols="'.$cols.'" rows="'.$rows.'" '.$thisclass.' id="'.$id.'" >'.$value.'</textarea>';
