...
if ($user->id==$this->row->created_by() || JEVHelper::isAdminUser($user) || JEVHelper::canDeleteEvent($this->row, $user)){
	...
	if ($this->jomsocial){
		$html = '<div class="cModule jevattendees" id="jevents_body"><h3><span>'.JText::_("JEV_INVITEES").'</span></h3>';
	}
	else {
		$html =" <div class='jevattendees' id='jevents_body'><h3>".JText::_("JEV_INVITEES")."</h3>";
	}
	...
	<div id="jev_name"  style="display:none" >
		<div class="jevusername" style="float:left;margin-right:10px;">'.JText::_("JEV_INVITEE_SEARCH").'
		</div>
		'.$typeahead.'
	</div>
...
<form action="index.php" method="post" name="adminForm" id="adminForm" >
  <input type="hidden" name="task" value="invites.overview" />
