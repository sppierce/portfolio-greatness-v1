...
set_time_limit(180);
$filename = "rsvp_export".JApplicationHelper::stringURLSafe($this->repeat->title()." ".$this->repeat->startDate())."_".$this->repeat->rp_id().".csv";
...
function outputCSV($data) {
	...
	foreach ($vals as $val){
        ...
        if (!isset($separator)){
            ...
            $separator = $compparams->get('csvseparator', ',');
        }
        fputcsv($filehandler, $temp, $separator, '"');
    }
