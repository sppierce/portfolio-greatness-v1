...
<div id="jevents" class="rsvppro_sessions">
    <form action="index.php" method="post" name="adminForm" id="adminForm">
        <div class="sessionfilters">
            ...
            <div class="floatleft">
                <?php echo JText::_('JEV_ON_OR_AFTER'); ?><br/>                    
                <?php 
            ...
            <?php if ($this->searchattendees) { ?>
            <div class="floatleft">
                <?php echo JText::_('RSVP_ATTENDED'); ?><br/>
                <input type="checkbox" name="searchdidattend" value="1" <?php echo $this->searchdidattend?"checked='checked'":"";?>
                       class="checkbox" onChange="document.adminForm.submit();"/>
            </div>
            <?php } ?>
            <div class="floatleft">
            ...
            <?php if (isset($this->catlist) && strpos($this->catlist, "<select")!==false) { ?>
            <div class="floatleft">
                <br/>
