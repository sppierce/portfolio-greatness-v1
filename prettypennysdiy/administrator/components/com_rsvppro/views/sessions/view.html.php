...
class AdminSessionsViewSessions extends RSVPAbstractView
{
	function overview($tpl = null)
	{
		...
		JToolBarHelper::title( JText::_( 'RSVP_SESSIONS' ), 'jevents' );
                ...
                JLoader::register('JToolbarButtonJevedit', JPATH_COMPONENT_ADMINISTRATOR . "/libraries/jevtoolbarbuttons.php");
             	$bar =  JToolBar::getInstance('toolbar');
		// Add a special edit bitton
		$bar->appendButton('Jevedit',  "new", "JTOOLBAR_NEW", 'icalevent.edit', false, false, "document.adminForm.updaterepeats.value");
		//$bar->appendButton('Jevedit',  "edit", "RSVP_Edit_Event", 'icalevent.edit', true, false, "document.adminForm.updaterepeats.value");
