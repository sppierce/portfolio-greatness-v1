        ...
        <div id="rightcol" class="">
            ...
            <div>
                ...
                <div class="themesblock ui-accordion ui-widget ui-helper-reset">
                    ...
                    <?php if($this->importFiles): ?>
                    <div class="well">
                        <h4 class="ui-accordion-header ui-state-default ui-accordion-icons"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMPORT'); ?></h4>
                        <div id="filesimport" class="ui-accordion-content">
                            <div id="jao"></div>
                            <div class="center">
                                <button class="btn btn-mini" id="selectAllImportFiles" type="button">Select all</button>
                                <button class="btn btn-large" id="importFilesBtn" type="button"><?php echo JText::_('COM_DROPPICS_LAYOUT_DROPPICS_IMPORT_BTN'); ?></button>
                    ...
                    <div class="well">
                        ...
                        <a class="themebtn <?php echo strtolower($theme['name']); ?>" title="<?php echo $theme['name']; ?>"  href="" data-theme="<?php echo $theme['id']; ?>"><?php echo $theme['name']; ?></a>
                        <?php endforeach; ?>
                        <div class="clrr"></div>
                        </div>
                    </div>

                    <div class="well hide_params_box" >
