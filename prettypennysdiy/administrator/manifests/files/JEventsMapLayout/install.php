...
class JEventsMapLayoutInstallerScript
{

	private $oldelement = "map";
	private $newelement = "JEventsMapLayout";
	/**
	...
	public function uninstall($parent)
	{
		...
		if (JFolder::exists(JPATH_SITE."/components/com_jevents/views/map")){
			JFolder::delete(JPATH_SITE."/components/com_jevents/views/map");
		}
		if (JFolder::exists(JPATH_SITE."/modules/mod_jevents_cal/tmpl/map")){
			JFolder::delete(JPATH_SITE."/modules/mod_jevents_cal/tmpl/map");
		}
		if (JFolder::exists(JPATH_SITE."/modules/mod_jevents_latest/tmpl/map")){
			JFolder::delete(JPATH_SITE."/modules/mod_jevents_latest/tmpl/map");
		}
		if (JFolder::exists(JPATH_SITE."/modules/mod_jevents_legend/tmpl/map")){
			JFolder::delete(JPATH_SITE."/modules/mod_jevents_legend/tmpl/map");
		}
	}
	//
	...
	public function postflight($type, $parent)
	{
		...
		if (JFile::exists(JPATH_ADMINISTRATOR."/manifests/files/map.xml")){
			JFile::delete(JPATH_ADMINISTRATOR."/manifests/files/map.xml");
		}
