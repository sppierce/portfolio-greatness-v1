...
class JEventsExtPlusLayoutInstallerScript
{

	private $oldelement = "extplus";
	private $newelement = "JEventsExtPlusLayout";
	...
	public function uninstall($parent)
	{
		...
		if (JFolder::exists(JPATH_SITE."/components/com_jevents/views/extplus")){
			JFolder::delete(JPATH_SITE."/components/com_jevents/views/extplus");
		}
		if (JFolder::exists(JPATH_SITE."/modules/mod_jevents_cal/tmpl/extplus")){
			JFolder::delete(JPATH_SITE."/modules/mod_jevents_cal/tmpl/extplus");
		}
		if (JFolder::exists(JPATH_SITE."/modules/mod_jevents_latest/tmpl/extplus")){
			JFolder::delete(JPATH_SITE."/modules/mod_jevents_latest/tmpl/extplus");
		}
		if (JFolder::exists(JPATH_SITE."/modules/mod_jevents_legend/tmpl/extplus")){
			JFolder::delete(JPATH_SITE."/modules/mod_jevents_legend/tmpl/extplus");
		}
	}
	...
	public function postflight($type, $parent)
	{
		...
		if (JFile::exists(JPATH_ADMINISTRATOR."/manifests/files/extplus.xml")){
			JFile::delete(JPATH_ADMINISTRATOR."/manifests/files/extplus.xml");
		}
