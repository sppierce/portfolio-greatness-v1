...
class MobileDetect
{
	...
	{
		$match = (bool) RegEx::match(sprintf('%s', $regex), (false === empty($userAgent) ? $userAgent : $this->userAgent), $matches);
	...
	public function version($propertyName, $type = self::VERSION_TYPE_STRING)
	{
		...
		if (true === isset($properties[$propertyName]))
		{
			...
			foreach ($properties[$propertyName] as $propertyMatchString)
			{
				...
				RegEx::match(sprintf('%s', $propertyPattern), $this->userAgent, $match);
