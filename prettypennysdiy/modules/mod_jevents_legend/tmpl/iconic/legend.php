 ...
 * @static
 */
if (file_exists(JPATH_SITE."/modules/mod_jevents_legend/mod_jevents_legend.php")) {
include_once(JPATH_SITE."/modules/mod_jevents_legend/tmpl/default/legend.php");

class IconicModLegendView extends DefaultModLegendView
{
	...
	function displayCalendarLegend($style = "list")
	{
		...
		if ((!is_null($active) && $active->component == JEV_COM_COMPONENT) || !isset($this->myItemid))
		{
