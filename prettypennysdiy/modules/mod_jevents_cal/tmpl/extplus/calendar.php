...
class ExtplusModCalView extends DefaultModCalView
{
...
START;
	...
	protected
			function getTooltip($currentDay, $linkattr)
	{
		$tooltip = "";
	...
	protected
			function getTooltipReference(&$currentDay, $linkattr)
	{
		...
		if ($params->get("epcolourscheme", 1)) {
                    JHtmlBootstrap::loadCss();
                }
