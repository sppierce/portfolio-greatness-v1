<?php
/**
 * copyright (C) 2008-12 GWE Systems Ltd - All rights reserved
 */
...
class RuthinModLatestView extends DefaultModLatestView  
{
	...
	public function displayLatestEvents(){
		...
		if(isset($this->eventsByRelDay) && count($this->eventsByRelDay)){
			...
			$content .= $this->modparams->get("modlatest_templatetop") ? $this->modparams->get("modlatest_templatetop") : '<table class="mod_events_latest_table jevbootstrap" >';
