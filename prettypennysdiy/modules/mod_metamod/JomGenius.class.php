 ...
 * v21 Content: added category_tags and article_tags for J3
 *     Core: browser and browsertype now return an array of types, as type can be more than one (android, safari etc)
 * v22 Content: prevented warning message from appearing when article information requested when on invalid page
 * v23 consolodated MetaMod and Chameleon version numbering for JomGenius, on Chameleon 2.47
 * v24 Core: improved detection of client IP address through 2 new types of proxy servers
 */
