...
class plgjeventsjevfacebooksocialInstallerScript
{
	//
	...
	public function preflight($type, $parent) 	{
        ...
        if ($is_enabled == 1)
        {
            ...
            {
                Jerror::raiseWarning(null, 'A minimum of JEvents V3.1.16 is required for this addon. <br/>Please update JEvents first.' . $rel);
                return false;
            }
            else
            {
	...
	function postflight($type, $parent) 
    {
		...
		echo '<h2>'.JText::_('JEV_FACEBOOK_SOCIAL_PLUGIN') . ' ' . $parent->get('manifest')->version.' </h2>';
		echo '<strong>';

		if ($type == "update") {
			echo JText::_('JEV_FACEBOOK_SOCIAL_INSTALL_SUCCESS_1') . '<br/>';
			echo JText::_('JEV_FACEBOOK_SOCIAL_PLUGIN_DESC');
		} else {
			echo JText::_('JEV_FACEBOOK_SOCIAL_INSTALL_SUCCESS_2') . '<br/>';
			echo JText::_('JEV_FACEBOOK_SOCIAL_PLUGIN_DESC');
		}
		echo '</strong><br/><br/>';
	}
