...
if (isset($_SERVER["REQUEST_URI"])) {
	$x = str_replace("plugins/jevents/jevrsvppro/rsvppro/invitefriends.php", "", $_SERVER["REQUEST_URI"]);
	echo header("Location:".$x."index.php?option=com_jevents&typeaheadtask=gwejson&file=invitefriends&path=plugin&folder=jevents&plugin=jevrsvppro/rsvppro&json={}");
	//include ("../../../index.php");
}
exit();
*/
