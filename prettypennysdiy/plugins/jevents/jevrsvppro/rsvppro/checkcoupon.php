...
/**
 * @copyright	Copyright (C) 2008-2017 GWE Systems Ltd. All rights reserved.
 * @license		By negoriation with author via http://www.gwesystems.com
 */

if (isset($_SERVER["REQUEST_URI"])) {
	$x = str_replace("plugins/jevents/jevrsvppro/rsvppro/checkcoupon.php", "", $_SERVER["REQUEST_URI"]);
	$json = json_decode($_POST["json"]);
	if ($json) {
		$json = json_encode($json);
		echo header("Location:".$x."index.php?option=com_jevents&typeaheadtask=gwejson&file=checkcoupon&path=plugin&folder=jevents&plugin=jevrsvppro/rsvppro&json=".$json);
	}
	//include ("../../../index.php");
}
exit();
