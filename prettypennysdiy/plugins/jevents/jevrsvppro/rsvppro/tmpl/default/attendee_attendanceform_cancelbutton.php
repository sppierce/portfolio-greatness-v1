...
{
	$html .='
		<input type="submit" class="jevclickcancel" value="' . JText::_('RSVP_CANCEL_ATTENDANCE') . '" onclick="' . $this->checkemail . $confirm . '" id="jevattendsubmit" />';
}
else
{
	$style = "";
	...
	$html .='
		<input type="submit" class="jevclickcancel" value="' . JText::_('RSVP_CANCEL_ATTENDANCE') . '" onclick="' . $this->checkemail . $confirm . '" ' . $style . ' id="jevattendsubmit" />';
}
echo $html;
