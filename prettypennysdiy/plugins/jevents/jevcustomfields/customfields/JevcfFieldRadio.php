...
class JevcfFieldRadio extends JFormFieldRadio
{	

	protected function getInput(){
		echo "should not call this directly ".  get_class($this)." is using JevcfFieldRadio<br/>";
	}
	...
	function toXML($field)
	{
		...
		$result[] = ">";
		// booleans have no declared options!
