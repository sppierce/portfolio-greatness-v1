...
?>
<div id="navigation">
    <a href="#" onclick="history.go(-1);"><?php echo JText::_('COM_DROPPICS_LAYOUT_MANAGE_BACK_PREVIOUS_PAGE'); ?></a> | <a href="<?php echo JUri::root();?>"><?php echo JText::_('COM_DROPPICS_LAYOUT_MANAGE_BACK_HOMEPAGE'); ?></a>
</div>
