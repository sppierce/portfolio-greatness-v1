...
<form action="<?php echo JRoute::_("index.php?option=com_rsvppro&task=attendees.transactions&Itemid=$Itemid"); ?>" method="post" name="adminForm" id="adminForm">
				...
				<tr class="row<?php echo $k; ?>">
					...
					<td   >
						<?php
							...
							$transactiondate = new JevDate($transaction->transaction_date);
							echo $transactiondate->toFormat($format)."<br/>";
