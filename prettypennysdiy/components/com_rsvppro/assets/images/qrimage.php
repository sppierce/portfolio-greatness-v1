...
{
    $code = str_replace("qrimage", "", JRequest::getString("file",""));
}
...
$url = $path . "index.php?option=com_rsvppro&task=attendees.attend&atd_id[]=$atd_id&cid[]=$cid&gc=$guestcount&notes[]=qrscanned&repeating=$repeating&sc=$securitycheck";
