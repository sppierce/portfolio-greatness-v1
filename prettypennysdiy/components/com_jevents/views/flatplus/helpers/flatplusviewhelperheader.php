...
function FlatplusViewHelperHeader($view){
    ...
    ?>
    <div id="jevents">
    <table class="contentpaneopen jeventpage<?php echo $params->get( 'pageclass_sfx' ); echo $params->get("darktemplate",0)?" jeventsdark":" "; echo $lang->isRTL()?" jevrtl":"jeventslight ";?> jevbootstrap" id="jevents_header">
        <tr>
...
<table class="contentpaneopen  jeventpage<?php echo $params->get( 'pageclass_sfx' );  echo $params->get("darktemplate",0)?" jeventsdark":"jeventslight "; echo $lang->isRTL()?" jevrtl":" "; ?> jevbootstrap" id="jevents_body">
        <tr>
            <td width="100%">
<?php
}