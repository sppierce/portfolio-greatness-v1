...
function ExtplusViewHelperFooter16($view)
{
	...
	if (($params->get('epscalable', 0) == 1 || $params->get("extpluswidth", 905) == "scalable") && (($task == "month.calendar" && !$params->get('eplistmonth', 0)) || ($task == "week.listevents" && $params->get('eptabularweek', 0)) ))
	{
		$baseurl = JURI::root();
