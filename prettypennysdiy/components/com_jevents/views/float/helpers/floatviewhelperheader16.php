...
function FloatViewHelperHeader16($view){
    ...
    $jevtype	= $jinput->getString('jevtype', null, null);
    $evid		= $jinput->getInt('evid', '');
    $pop		= $jinput->geInt('pop', 0);
    ...
    // Call the MetaTag setter function - introduced in JEvents 3.0.14 - so make sure its available before calling it!
